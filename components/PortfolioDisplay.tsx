			...
			<div className="relative z-10">
						...
						<div className="grid md:grid-cols-3 gap-6">
							...
							<div className="bg-gradient-to-br from-purple-500/10 to-cyan-500/10 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-purple-400/50 transition">
								<div className="space-y-6">
									...
									<div>
										<p className="text-4xl font-bold text-cyan-400">{skills.length}</p>
				...
				<footer className="border-t border-white/10 py-8 px-4 mt-20">
					<div className="max-w-6xl mx-auto text-center text-gray-500 text-sm">
						<p>
							© {new Date().getFullYear()} {fullName}. Built with Next.js, React & Tailwind CSS.
						</p>
					</div>
				</footer>
			</div>
...
// Helper variable for email link (you can replace with actual email if needed)
const linkString = "hello@example.com";
